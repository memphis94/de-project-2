...
SELECT 
	...
	CASE WHEN ss.shipping_end_fact_datetime > si.shipping_plan_datetime THEN EXTRACT(DAY FROM (AGE(ss.shipping_end_fact_datetime,si.shipping_plan_datetime))) ELSE 0 END AS delay_day_at_shipping,
	si.payment_amount,
